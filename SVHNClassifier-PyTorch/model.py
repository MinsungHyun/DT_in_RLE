...
class Model(nn.Module):
    ...
    def __init__(self):
        ...
        self._digit_length = nn.Sequential(nn.Linear(3072, 10))
        ...
        self._digit6 = nn.Sequential(nn.Linear(3072, 11))
        self._digit7 = nn.Sequential(nn.Linear(3072, 11))
        self._digit8 = nn.Sequential(nn.Linear(3072, 11))
        self._digit9 = nn.Sequential(nn.Linear(3072, 11))
        self._digit10 = nn.Sequential(nn.Linear(3072, 11))
