...
parser.add_argument('-c', '--checkpoint', default='./logs/model-1154000.tar', type=str, help='path to evaluate checkpoint')
parser.add_argument('-d', '--data_dir', default='../pytorch-a2c-ppo-acktr/data/SpaceInvadersNoFrameskip-v4', help='directory to read LMDB files')
