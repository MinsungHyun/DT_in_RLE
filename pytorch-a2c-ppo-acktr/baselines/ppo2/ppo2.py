...
class Runner(AbstractEnvRunner):
    ...
    def run(self):
        ...
        max_rewards = np.max(mb_rewards)
        mean_rewards = np.mean(mb_rewards)
        median_rewards = np.median(mb_rewards)
        ...
        return (*map(sf01, (mb_obs, mb_returns, mb_dones, mb_actions, mb_values, mb_neglogpacs)),
            mb_states, epinfos, max_rewards, mean_rewards, median_rewards)
